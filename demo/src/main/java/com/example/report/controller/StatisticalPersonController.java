...
@RestController
@RequestMapping("/statistical-person")
public class StatisticalPersonController {
    ...
    public @ResponseBody DataTableResults<StatisticalPersonBean> search(HttpServletRequest req, SearchStatisticalForm form){
        return employeeService.searchStatistical(form);
    }
